...
from ..workers.reward import BatchFunctionRewardManager, SequentialFunctionRewardManager, LLMBatchMEMFunctionRewardManager
...
class Runner:
    ...
    def run(self, config: PPOConfig):
        ...
        elif config.worker.reward.reward_type == "llm_batch_Memory":
            RewardManager = LLMBatchMEMFunctionRewardManager
        else:
